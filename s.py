...
╚═══════════╝
  """
helpset="""╔(╣ S༘̏̏Ȅ༘̏T༘̏̏T༘̏̏Ȉ༘̏N༘̏̏G༘̏̏ ̏- B༘̏̏Ȍ༘̏T༘̏̏S༘̏̏.╣)╗
║ ✰ Ban:on/Unbl:on
║ ✰ Contact:on/off
║ ✰ Add:on/off
║ ✰ Join:on/off
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'tagme':"Tag msg not set",
    'sider1':"sider msg not set",
    'joingc':"welcome msg not set",
    'leftgc':"member left msg not set",
    "stickerMention":False,
    'message':"""THANKS FOR ADDING ME \n want bots in your group? \n add bot creator id - iamguru12 \n https://line.me/ti/p/v8uSSzQ43W""",
    "lang":"JP",
	    ...
	    if "Xvideos " in msg.text:
            ...
            if "Help" == msg.text:
              if msg.from_ in PRANKBOT:
                if wait["lang"] == "JP":
                	...
                	msg.contentType = 13
                	acil.sendText(msg.to,"GROUP PROTECTION BOTS AND SELFBOTS AVAILABLE CONTACT CREATOR . \n ID - IAMGURU12 ")
            ...
            if "Respon" == msg.text:
              if msg.from_ in PRANKBOT:
                ...
                ki5.sendMessage(msg)
                ki.sendText(msg.to,"group is safe Commander👮")
            if "Set" == msg.text:
              if msg.from_ in PRANKBOT:
                md = "╔▬▬id - iAmGuru12▬▬╗\n║▬▬▬℘▬▬в▬▬▬║\n"
            ...
            if "Sider:on" in msg.text:
	          if msg.from_ in PRANKBOT:
                    ...
                    wait["Sider"] = True
                    acil.sendText(msg.to,"Ready On Sider Check")
            if "Sider:off" in msg.text:
	          if msg.from_ in PRANKBOT:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    acil.sendText(msg.to, " Sider Off")
...
#==================================================
            ...
            if "Wc" in msg.text:
              if msg.from_ in PRANKBOT:
                ...
                acil.sendText(msg.to,"Owner of Group " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
            if "Say " in msg.text:
              if msg.from_ in PRANKBOT:
            ...
            if "Help" == msg.text:
              if msg.from_ in wait["ACIL"]:
                if wait["lang"] == "JP":
                	...
                	msg.contentType = 13
                	msg.contentMetadata = {'mid':'u81309ce03e9af2a78ccd777075eb2c2e'}
                	acil.sendText(msg.to,"SELFBOTS AND PROTECTION BOTS AVAILABLE \n CONTACT CREATOR GURU id - iAmGuru12")
                	acil.sendMessage(msg)
                else:
                    acil.sendText(msg.to,helpMessage1)
                    msg.contentType = 13
...
#----------------------------------------------
		    ...
		    a = msg.text.replace("Xvideos ","")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid':'u81309ce03e9af2a78ccd777075eb2c2e'}
                acil.sendText(msg.to,"GROUP PROTECTION BOTS AND SELFBOTS AVAILABLE CONTACT CREATOR  ID - IAMGURU12 ")
                acil.sendMessage(msg)
	...
	#      if msg.toType == 2:
                ...
                for target in targets:
                   try:
                      ...
                      f=codecs.open('st2__a.json','w','utf-8')
                      json.dump(wait["ACIL"], f, sort_keys=True, indent=4,ensure_ascii=False)
                      acil.sendText(msg.to,"ADMIN ADDED")
                      print "[Admin]ADDED"
                   except:
                      pass
